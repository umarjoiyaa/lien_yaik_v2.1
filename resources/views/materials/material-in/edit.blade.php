@extends('layouts.app')
@push('title')
    <title>MATERIAL IN UPDATE</title>
@endpush
@section('index')
    MATERIAL IN
@endsection
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('material-in.update', $material_in->id) }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="date" type="date" value="{{ $material_in->date }}" class="form-control">
                        </div>
                    </div>
                ...
                <div class="row px-3">
                    ...
                    <div class="mr-auto mt-2"><a href="{{ route('material-in.index') }}">Go Back</a></div>
