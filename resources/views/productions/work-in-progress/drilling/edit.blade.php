@extends('layouts.app')
@push('title')
    <title>DRILLING UPDATE</title>
@endpush
@section('index')
    DRILLING
@endsection
@section('content')
    <form action="{{ route('drilling.update', $drilling->id) }}" method="POST">
        @csrf
        <div class="card">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="batch_no" id="batch_id" class="form-select">
                                ...
                                @foreach ($batches as $batch)
                                    <option value="{{ $batch->id }}" @selected($drilling->batch_id == $batch->id)>{{ $batch->batch_no }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <textarea name="remarks" class="form-control" id="" cols="30" rows="1">{{ $drilling->remarks }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="date" type="date" value="{{ $drilling->date }}" class="form-control">
                        </div>
                    </div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/custom/productions/in-progress/drilling/edit.js') }}"></script>
@endpush
