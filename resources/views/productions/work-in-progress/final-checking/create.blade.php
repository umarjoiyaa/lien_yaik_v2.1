@extends('layouts.app')
@push('title')
    <title>FINAL CHECKING CREATE</title>
@endpush
@section('index')
    FINAL CHECKING
@endsection
@section('content')
    <form action="{{ route('final-checking.store') }}" method="POST">
        @csrf
        <div class="card">
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/custom/productions/in-progress/final-checking/create.js') }}"></script>
@endpush
