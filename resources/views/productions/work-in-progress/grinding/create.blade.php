@extends('layouts.app')
@push('title')
    <title>GRINDING CREATE</title>
@endpush
@section('index')
    GRINDING
@endsection
@section('content')
    <form action="{{ route('grinding.store') }}" method="POST">
        @csrf
        <div class="card">
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/custom/productions/in-progress/grinding/create.js') }}"></script>
@endpush
