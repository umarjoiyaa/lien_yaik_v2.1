@extends('layouts.app')
@push('title')
    <title>GRINDING UPDATE</title>
@endpush
@section('index')
    GRINDING
@endsection
@section('content')
    <form action="{{ route('grinding.update', $grinding->id) }}" method="POST">
        @csrf
        <div class="card">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="batch_no" id="batch_id" class="form-select">
                                ...
                                @foreach ($batches as $batch)
                                    <option value="{{ $batch->id }}" @selected($grinding->batch_id == $batch->id)>{{ $batch->batch_no }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <textarea name="remarks" class="form-control" id="" cols="30" rows="1">{{ $grinding->remarks }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="date" type="date" value="{{ $grinding->date }}" class="form-control">
                        </div>
                    </div>
        ...
        <div class="row px-3">
            ...
            <div class="mr-auto mt-2"><a href="{{ route('grinding.index') }}">Go Back</a></div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/custom/productions/in-progress/grinding/edit.js') }}"></script>
@endpush
