...
$(document).ready(function () {
    ...
    if (typeof (Storage) !== "undefined" && sessionStorage.getItem("savedDrilling2")) {
        ...
        var savedDrilling3 = sessionStorage.getItem("savedDrilling3");
        var customError = $('.custom-error:visible');
        if (savedDrilling2 && customError.length > 0) {
            $("#myTable4 tbody").html(savedDrilling2);
        ...
        if (savedDrilling3 && customError.length > 0) {
            $("#myTable6 tbody").html(savedDrilling3);
...
$('.submit').click(function () {
    ...
    if (typeof (Storage) !== "undefined") {
        ...
        if ($('#myTable4 tbody tr').length > 1) {
            sessionStorage.setItem("savedDrilling2", tbody2);
        } else {
            sessionStorage.setItem("savedDrilling2", '');
        }
        if ($('#myTable6 tbody tr').length > 1) {
            sessionStorage.setItem("savedDrilling3", tbody3);
        } else {
            sessionStorage.setItem("savedDrilling3", '');
        }
