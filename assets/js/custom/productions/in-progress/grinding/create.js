...
$(document).ready(function () {
    ...
    if (typeof (Storage) !== "undefined" && sessionStorage.getItem("savedGrinding2")) {
        ...
        var savedGrinding3 = sessionStorage.getItem("savedGrinding3");
        var customError = $('.custom-error:visible');
        if (savedGrinding2 && customError.length > 0) {
            $("#myTable4 tbody").html(savedGrinding2);
        ...
        if (savedGrinding3 && customError.length > 0) {
            $("#myTable6 tbody").html(savedGrinding3);
...
$('.submit').click(function () {
    ...
    if (typeof (Storage) !== "undefined") {
        ...
        if ($('#myTable4 tbody tr').length > 1) {
            sessionStorage.setItem("savedGrinding2", tbody2);
        } else {
            sessionStorage.setItem("savedGrinding2", '');
        }
        if ($('#myTable6 tbody tr').length > 1) {
            sessionStorage.setItem("savedGrinding3", tbody3);
        } else {
            sessionStorage.setItem("savedGrinding3", '');
        }
